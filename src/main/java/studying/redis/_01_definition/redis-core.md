...
- Q1-1. NoSQL이 무엇인가요?
- Q1-2. NoSQL의 주요 특징은 무엇인가요?
- Q1-3. NoSQL은 어떤 종류의 데이터를 다루는데 적합한가요?
- Q1-4. NoSQL의 유형은 어떤 것이 있나요?

### 2. Redis 기본 개념

- Q2-1. Redis가 무엇인가요?
- Q2-2. Redis와 RDBMS의 단점을 각각 말해보세요.

### 3. Redis 특징

- Q3-1. Redis의 실시간 응답 특징은 어떻게 구현되나요?
- Q3-2. Redis가 지원하는 데이터 구조와 스레드 모델을 설명해보세요.
- Q3-3. Redis의 고가용성은 어떻게 보장되나요?
- Q3-4. Redis의 확장성과 클라우드 네이티브 특징을 설명해보세요.

### 4. Redis 도입 시점

- Q4-1. Redis를 도입해야 하는 시점은 언제인가요?
- Q4-2. RDBMS 조인 결과를 캐싱할 때 Redis의 장점은 무엇인가요?

### 5. Redis 영속성

- Q5-1. Redis의 영속성을 위한 두 가지 방식을 설명해보세요.

### 6. MSA에서 Redis 메시지 브로커

- Q6-1. Redis를 메시지 브로커로 사용하는 방법을 설명해보세요.
...
### 3-4. Redis의 확장성과 클라우드 네이티브 특징을 설명해보세요.
...
### 4-2. RDBMS 조인 결과를 캐싱할 때 Redis의 장점은 무엇인가요?

**A:** RDBMS에서 여러 테이블을 조인한 결과가 여러번 사용되는 경우에는 Redis 캐싱을 통해 빠른 속도를 기대할 수 있습니다.

## 5. Redis 영속성

### 5-1. Redis의 영속성을 위한 두 가지 방식을 설명해보세요.
...
### Q6-1. Redis를 메시지 브로커로 사용하는 방법 3가지를 설명해보세요.
